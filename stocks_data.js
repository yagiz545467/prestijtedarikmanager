...
<body class="flex items-center justify-center min-h-screen p-4">
        ...
        <div id="main-content" class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div id="file-list-pane" class="md:col-span-2 p-6 rounded-lg bg-gray-700 shadow-lg item-list-container">
                ...
                <div id="file-list" class="space-y-2">
                    <!-- Dosyalar ve Klasörler buraya eklenecek -->
                </div>
            </div>
    ...
    <script type="module">
        ...
        // Başlangıç verilerini harici bir dosyadan içe aktarmak yerine doğrudan buraya gömüyoruz.
        // Bu, tarayıcıların dosya erişim kısıtlamalarını aşmamızı sağlar.
        ...
        // Firebase için detaylı loglamayı etkinleştir.
        setLogLevel('debug');

        // Bu boş Firebase yapılandırma nesnesini, kendi bilgilerinizle değiştirin.
        // Bilgilerinizi Firebase projenizin ayarlarından (Proje Ayarları > Genel) bulabilirsiniz.
        ...
        // Global Firebase ve Uygulama Değişkenleri
        let db;
        let auth;
        let isAuthReady = false;
        let currentPath = ''; // Root için boş string
        let pathHistory = [];
        ...
        // Firestore ve Kimlik Doğrulama Başlatma
        window.onload = async () => {
            try {
                ...
                if (typeof __firebase_config !== 'undefined') {
                    ...
                    // Kullanıcı tarafından sağlanan yapılandırmayı kullan
        ...
        // Uygulama ilk açıldığında varsayılan verileri yükle
        async function initializeDefaultData() {
            ...
            if (docs.empty) {
                ...
                for (const item of initialFileSystem) {
        ...
        function listenToFileSystem() {
            ...
            onSnapshot(q, (querySnapshot) => {
                ...
                // Hata mesajını göstermeyin, çünkü onSnapshot bazen geçici hatalarda da çalışır.
            });
        }
